...
How to Use
Enter URLs: Provide up to 3 news article URLs in the sidebar.
Process Data: Click "Process URLs" to extract content and build the FAISS index.
Ask Questions: Use the input field on the main page to ask questions about the processed articles.
View Results: The app displays the context and answers based on your query.
Code Overview
Key Components
Data Extraction:
